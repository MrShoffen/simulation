...
>-Нарушение SRP, создающий метод, который знает часть логики чужой ответственности- что приложению нужно создавать существо со случайными параметрами в рамках заданного диапазона.
